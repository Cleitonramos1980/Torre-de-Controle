...
function classificacaoBadge(cls) {
    ...
    const style = map[cls] || { bg: "#f1f5f9", color: "#475569" };
    return h("span", {
...
function ScoreBar({ score }) {
    ...
    return hs("div", {
        ...
        children: [
            hs("div", {
                style: { width: 80, height: 10, background: "#e2e8f0", borderRadius: 5, overflow: "hidden" },
                children: [
...
function KpiCard({ title, value, bg, color }) {
    return hs("div", {
        style: { background: bg || "#fff", border: "1px solid #e2e8f0", borderRadius: 8, padding: "16px 20px", minWidth: 120 },
        children: [
            h("div", { style: { fontSize: 12, color: color ? "#fff" : "#64748b", marginBottom: 4, opacity: color ? 0.85 : 1 }, children: title }),
    ...
    return hs("div", {
        ...
        children: [
            hs("div", {
                ...
                children: [
                    h("h1", { style: { fontSize: 22, fontWeight: 700, color: "#1e293b", margin: 0 }, children: "Motor de Risco Fiscal" }),
                    h("p", { style: { fontSize: 14, color: "#64748b", marginTop: 4 }, children: "Ranking de documentos fiscais por score de risco calculado pelas regras ativas." }),
                ],
            }),
            ...
            !loading && hs(Card, {
                ...
                children: [
                    h("div", { style: { padding: "16px 20px 8px", fontWeight: 700, fontSize: 15, color: "#1e293b" }, children: "Ranking de Documentos por Risco" }),
                    h(CardContent, {
                            ...
                            children: hs("tbody", {
                                children: [
                                    h("tr", {
                                        ...
                                        children: [
                                            h("th", { style: { padding: "10px 12px", textAlign: "left", fontWeight: 600, color: "#475569" }, children: "#" }),
                                            h("th", { style: { padding: "10px 12px", textAlign: "left", fontWeight: 600, color: "#475569" }, children: "Chave" }),
                                            h("th", { style: { padding: "10px 12px", textAlign: "left", fontWeight: 600, color: "#475569" }, children: "Tipo" }),
                                            h("th", { style: { padding: "10px 12px", textAlign: "left", fontWeight: 600, color: "#475569" }, children: "Emitente" }),
                                            h("th", { style: { padding: "10px 12px", textAlign: "left", fontWeight: 600, color: "#475569" }, children: "Score" }),
                                            h("th", { style: { padding: "10px 12px", textAlign: "left", fontWeight: 600, color: "#475569" }, children: "Classificação" }),
                                            h("th", { style: { padding: "10px 12px", textAlign: "left", fontWeight: 600, color: "#475569" }, children: "Data Cálculo" }),
                                        ],
                                    }),
                                    ...docsFiltrados.length === 0
                                        ? [h("tr", { children: h("td", { colSpan: 7, style: { padding: 40, textAlign: "center", color: "#64748b" }, children: "Nenhum documento encontrado." }) })]
                                        : docsFiltrados.map((doc, idx) => h("tr", {
                                            style: { borderBottom: "1px solid #f1f5f9" },
                                            children: [
                                                h("td", { style: { padding: "8px 12px", fontWeight: 700, color: "#64748b" }, children: idx + 1 }),
                                                h("td", { style: { padding: "8px 12px", fontFamily: "monospace", fontSize: 12 }, children: truncar(doc.chave, 20) }),
                                                h("td", { style: { padding: "8px 12px" }, children: h("span", { style: { background: "#dbeafe", color: "#1e40af", padding: "2px 8px", borderRadius: 9999, fontSize: 12, fontWeight: 600 }, children: doc.tipo || "-" }) }),
            ...
            !loading && hs(Card, {
                style: { marginBottom: 24 },
                children: [
                    h("div", { style: { padding: "16px 20px 8px", fontWeight: 700, fontSize: 15, color: "#1e293b" }, children: "Ranking Fornecedores de Risco (Top 10)" }),
                    h(CardContent, {
                        style: { padding: 0, overflowX: "auto" },
                        children: h("table", {
                            style: { width: "100%", borderCollapse: "collapse", fontSize: 13 },
                            children: hs("tbody", {
                                children: [
                                    h("tr", {
                                        ...
                                        children: [
                                            h("th", { style: { padding: "10px 12px", textAlign: "left", fontWeight: 600, color: "#475569" }, children: "#" }),
                                            h("th", { style: { padding: "10px 12px", textAlign: "left", fontWeight: 600, color: "#475569" }, children: "Nome / Razão Social" }),
                                            h("th", { style: { padding: "10px 12px", textAlign: "left", fontWeight: 600, color: "#475569" }, children: "CNPJ" }),
                                            h("th", { style: { padding: "10px 12px", textAlign: "center", fontWeight: 600, color: "#475569" }, children: "Score Médio" }),
                                            h("th", { style: { padding: "10px 12px", textAlign: "center", fontWeight: 600, color: "#475569" }, children: "Qtd. Docs" }),
                                        ],
                                    }),
                                    ...fornecedores.length === 0
                                        ? [h("tr", { children: h("td", { colSpan: 5, style: { padding: 40, textAlign: "center", color: "#64748b" }, children: "Sem dados de fornecedores." }) })]
            ...
            !loading && hs(Card, {
                children: [
                    h("div", { style: { padding: "16px 20px 8px", fontWeight: 700, fontSize: 15, color: "#1e293b" }, children: "Regras Ativas" }),
                    h(CardContent, {
                        style: { padding: 0, overflowX: "auto" },
                        children: h("table", {
                            style: { width: "100%", borderCollapse: "collapse", fontSize: 13 },
                            children: hs("tbody", {
                                children: [
                                    h("tr", {
                                        style: { background: "#f8fafc", borderBottom: "1px solid #e2e8f0" },
                                        children: [
                                            h("th", { style: { padding: "10px 12px", textAlign: "left", fontWeight: 600, color: "#475569" }, children: "Código" }),
                                            h("th", { style: { padding: "10px 12px", textAlign: "left", fontWeight: 600, color: "#475569" }, children: "Descrição" }),
                                            h("th", { style: { padding: "10px 12px", textAlign: "center", fontWeight: 600, color: "#475569" }, children: "Pontos" }),
                                        ],
                                    }),
                                    ...regras.length === 0
                                        ? [h("tr", { children: h("td", { colSpan: 3, style: { padding: 40, textAlign: "center", color: "#64748b" }, children: "Nenhuma regra ativa cadastrada." }) })]
                                        : regras.map((r, idx) => h("tr", {
                                            style: { borderBottom: "1px solid #f1f5f9" },
                                            children: [
                                                h("td", { style: { padding: "8px 12px", fontFamily: "monospace", fontWeight: 600 }, children: r.codigo || r.code || "-" }),
                                                h("td", { style: { padding: "8px 12px", color: "#475569" }, children: r.descricao || r.description || "-" }),
