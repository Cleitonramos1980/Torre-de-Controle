import { z } from "zod";
import { getClientes, getEstoquePlanta, getItensPedidoByNumped, getMateriais, getNfTroca, getNfVenda, getPedidoItens, getPedidos, getPedidosByCodcli, searchSacClientesDirectOracle, } from "../repositories/erpRepository.js";
export async function erpRoutes(app) {
    ...
    app.get("/api/erp/clientes-sac-busca", async (req) => {
        const q = z
            ...
            cliente: z.string().optional().transform((v) => v?.trim()),
