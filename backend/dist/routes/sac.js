...
import { optionalStringOrNumberAsString, optionalText, requiredText, stringOrNumberAsString, } from "../types/validators.js";
    ...
    app.post("/api/sac/atendimentos/:id/anexos", async (req, reply) => {
        ...
        for await (const part of parts) {
            ...
            if (!isAllowedAttachment(part.filename, mimeType)) {
                ...
                appendAudit("UPLOAD_REJEITADO", "SAC_ANEXO", id, `Arquivo rejeitado (${part.filename}) - tipo ${mimeType}`, "system");
                continue;
            }
