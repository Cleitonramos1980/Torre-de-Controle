...
export async function qualidadeRoutes(app) {
    ...
    app.post("/api/garantias", async (req) => {
        ...
        return qualidadeRepo.createGarantia(body);
    });
    app.put("/api/garantias/:id", async (req) => {
        ...
        return qualidadeRepo.updateGarantia(id, body);
    });
    ...
    app.post("/api/nc", async (req) => {
        ...
        return qualidadeRepo.createNc(body);
    });
    app.put("/api/nc/:id", async (req) => {
        ...
        return qualidadeRepo.updateNc(id, body);
    });
    ...
    app.post("/api/capa", async (req) => {
        ...
        return qualidadeRepo.createCapa(body);
    });
}
