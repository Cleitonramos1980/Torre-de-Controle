...
export async function governancaQualidadeRoutes(app) {
    ...
    app.put("/api/qualidade/documentos/:id", async (req, reply) => {
        ...
        if (!updated)
            return reply.status(404).send({ error: { message: "Documento nao encontrado" } });
        return updated;
    });
    ...
    app.put("/api/qualidade/treinamentos/:id", async (req, reply) => {
        ...
        if (!updated)
            return reply.status(404).send({ error: { message: "Treinamento nao encontrado" } });
        return updated;
    });
    ...
    app.put("/api/qualidade/treinamentos/participantes/:id", async (req, reply) => {
        ...
        if (!updated)
            return reply.status(404).send({ error: { message: "Participante nao encontrado" } });
        return updated;
    });
    ...
    app.put("/api/qualidade/mudancas/:id", async (req, reply) => {
        ...
        if (!updated)
            return reply.status(404).send({ error: { message: "Mudanca nao encontrada" } });
        return updated;
    });
    ...
    app.put("/api/qualidade/fornecedores/:id", async (req, reply) => {
        ...
        if (!updated)
            return reply.status(404).send({ error: { message: "Fornecedor nao encontrado" } });
        return updated;
    });
    ...
    app.put("/api/qualidade/scar/:id", async (req, reply) => {
        ...
        if (!updated)
            return reply.status(404).send({ error: { message: "SCAR nao encontrada" } });
        return updated;
    });
    ...
    app.post("/api/qualidade/metrologia/instrumentos", async (req) => {
        ...
        return governancaQualidadeRepo.createInstrumentoMetrologia(body);
    });
    app.put("/api/qualidade/metrologia/instrumentos/:id", async (req, reply) => {
        ...
        const updated = governancaQualidadeRepo.updateInstrumentoMetrologia(id, body);
        if (!updated)
            return reply.status(404).send({ error: { message: "Instrumento nao encontrado" } });
        return updated;
    });
    ...
    app.post("/api/qualidade/metrologia/msa", async (req) => {
        ...
        return governancaQualidadeRepo.createEstudoMsa(body);
    });
    app.put("/api/qualidade/metrologia/msa/:id", async (req, reply) => {
        ...
        const updated = governancaQualidadeRepo.updateEstudoMsa(id, body);
        if (!updated)
            return reply.status(404).send({ error: { message: "Estudo MSA nao encontrado" } });
        return updated;
    });
    ...
    app.post("/api/qualidade/kpis-industriais", async (req) => {
        ...
        return governancaQualidadeRepo.createIndicadorIndustrial(body);
    });
    app.put("/api/qualidade/kpis-industriais/:id", async (req, reply) => {
        ...
        const updated = governancaQualidadeRepo.updateIndicadorIndustrial(id, body);
        if (!updated)
            return reply.status(404).send({ error: { message: "Indicador nao encontrado" } });
        return updated;
    });
    ...
    app.post("/api/qualidade/risco-sla/regras", async (req) => {
        ...
        return governancaQualidadeRepo.createRegraRiscoSla(body);
    });
    app.put("/api/qualidade/risco-sla/regras/:id", async (req, reply) => {
        ...
        const updated = governancaQualidadeRepo.updateRegraRiscoSla(id, body);
        if (!updated)
            return reply.status(404).send({ error: { message: "Regra de risco/SLA nao encontrada" } });
        return updated;
    });
    ...
    app.post("/api/qualidade/risco-sla/avaliacoes", async (req) => {
        ...
        return governancaQualidadeRepo.createAvaliacaoRiscoSla(body);
    });
    ...
    app.post("/api/qualidade/auditorias-camadas", async (req) => {
        ...
        return governancaQualidadeRepo.createAuditoriaCamada(body);
    });
    app.put("/api/qualidade/auditorias-camadas/:id", async (req, reply) => {
        ...
        const updated = governancaQualidadeRepo.updateAuditoriaCamada(id, body);
        if (!updated)
            return reply.status(404).send({ error: { message: "Auditoria em camada nao encontrada" } });
        return updated;
    });
    ...
    app.post("/api/qualidade/fornecedores/gates", async (req) => {
        ...
        return governancaQualidadeRepo.createGateFornecedor(body);
    });
    app.put("/api/qualidade/fornecedores/gates/:id", async (req, reply) => {
        ...
        const updated = governancaQualidadeRepo.updateGateFornecedor(id, body);
        if (!updated)
            return reply.status(404).send({ error: { message: "Gate de fornecedor nao encontrado" } });
        return updated;
    });
    ...
    app.post("/api/qualidade/iso9001/readiness", async (req) => {
        ...
        return governancaQualidadeRepo.createIsoReadiness(body);
    });
    app.put("/api/qualidade/iso9001/readiness/:id", async (req, reply) => {
        ...
        const updated = governancaQualidadeRepo.updateIsoReadiness(id, body);
        if (!updated)
            return reply.status(404).send({ error: { message: "Item ISO readiness nao encontrado" } });
        return updated;
    });
}
