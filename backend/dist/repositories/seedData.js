...
export function seedInventarioData() {
    if (db.inventarioLojas.length > 0)
        return;
    db.inventarioLojas = [
    ...
    db.inventarioTarefas = db.inventarioContagens.map((c, i) => ({
...
export function seedOperacionalData() {
    if (db.operacionalAcessos.length > 0)
        return;
