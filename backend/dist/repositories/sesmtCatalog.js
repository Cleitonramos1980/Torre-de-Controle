...
function moduleDef(input) {
    return {
        ...input,
        groupLabel: GROUPS[input.groupKey],
        visibility: input.visibility ?? "STANDARD",
    };
}
export const SESMT_MODULE_DEFINITIONS = [
    moduleDef({
...
export const SESMT_EXECUTIVE_VIEWS = [
    ...
    { key: "gerencial-ocupacional", label: "Gerencial Ocupacional", visibility: "SENSITIVE_HEALTH" },
];
...
export function getSesmtModuleDefinition(moduleKey) {
